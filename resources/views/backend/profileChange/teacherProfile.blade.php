...
@section('content')
    ...
    <ul class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li class="active">Teacher My Account</li>
    </ul>
    <!-- END BREADCRUMB -->

    <!-- PAGE TITLE -->
    <div class="page-title">
        <h2><span class="fa fa-lock"></span> Teacher My Account</h2>
    </div>
    <!-- END PAGE TITLE -->
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form method="POST" action="{{ url('teacher/my-account/' . $getRecordAll->id) }}" enctype="multipart/form-data" class="form-horizontal">
