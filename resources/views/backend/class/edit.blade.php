                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        <input name="name" value="{{ old('name',$getclass->name)  }}"type="text" class="form-control" required />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <select required class="form-control" name="status">
                                                        <option value="1" {{ $getclass->status == 1 ? 'selected' : '' }}>Active</option>
                                                        <option value="0" {{ $getclass->status == 0 ? 'selected' : '' }}>Inactive</option>
                                                    </select>
                                                </div>
                                            </div>
