...
@section('content')
    ...
    <ul class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li class="active">Edit Single Assign Class Teacher</li>
    </ul>
    <!-- END BREADCRUMB -->

    <!-- PAGE TITLE -->
    <div class="page-title">
        <h2><span class="fa fa-arrow-circle-o-left"></span>  Edit Single Assign Class Teacher</h2>
    </div>
    <!-- END PAGE TITLE -->
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="page-content-wrap">
                        <div class="row">
                            <div class="col-md-12">
                                <form method="POST" action="{{ url('panel/assign-class-teacher/edit-single/' . $getRecord->id) }}"
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 col-xs-12 control-label">
                                                    Teachers <span class="text-red-500">*</span>
                                                </label>
                                                <div class="col-md-6 col-xs-12">
                                                    <select required class="form-control" name="teacher_id" id="teacher_id">
                                                        ...
                                                        @foreach ($getteacher as $teacher)
                                                            <option value="{{ $teacher->id }}"
                                                                {{ isset($getRecord) && $getRecord->teacher_id == $teacher->id ? 'selected' : '' }}>
