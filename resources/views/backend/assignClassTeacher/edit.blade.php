            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="page-content-wrap">
                        <div class="row">
                            <div class="col-md-12">
                                <form method="POST" action="{{ url('panel/assign-class-teacher/edit/' . $getRecord->id) }}"
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            ...
                                            @php
                                                // Collect assigned teacher IDs for quick lookup
                                                $assignedTeacherIds = $getSelectedTeacher->pluck('teacher_id')->toArray();
                                            @endphp
